...
# objectif de la séquence : ajuster un modèle mixte sous R et trouver le bon 
# compromis complexité / parcimonie
#------------------------------------------------------------------------------#
...
# on ne gagne pas grand chose avec l'emboîtement d'effets aléatoires : ce n'est 
# pas très étonnant vu le peu d'information qu'ils contiennent, en particulier
# le niveau RG qu'il n'est probablement pas pertinent de conserver car il est 
